<template>
    <div class="space-y-4 pb-2">
        ...
        <div class="aspect-w-3 aspect-h-2">
          <vue-gravatar class="object-cover w-48 m-auto shadow" :email="author.email" :size="150" />
        </div>
        <!--Author Name-->
        ...
        <ul role="list" class="flex space-x-5 justify-center">
            <!--Social icon-->
            <SocialLink v-if="author.twitter_link" :link="author.twitter_link">
          ...
          <SocialLink v-if="author.github_link" :link="author.github_link">
          ...
          <SocialLink v-if="author.website_link" :link="author.website_link">
        ...
        <div class="text-sm px-7">
          <p class="text-gray-500">{{ author.about_info }}</p>
        </div>
    </div>
</template>
